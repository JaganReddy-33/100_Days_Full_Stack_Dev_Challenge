...
public class TransactionService {
    ...
    public boolean createTransaction(Transaction transaction) throws SQLException {
    	...
    	if(transaction.getTransactionReference() == null || transaction.getTransactionReference().trim().isEmpty()) {
    		return false;
    	}
    	...
    	if (transaction.getRiskScore() < 0 || transaction.getRiskScore() > 100) {    
    		return false;    
    	}
