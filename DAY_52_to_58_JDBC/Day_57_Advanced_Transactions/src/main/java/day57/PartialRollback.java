...
public class PartialRollback {

    private static final String UPDATE_QUERY =
            "UPDATE accounts SET balance = balance + ? WHERE account_id = ?";

    public static void partialRollbackExample() throws ClassNotFoundException, SQLException {
        ...
        try (Connection con = ConnectionEx.getConnection();
            ...
            try {
                ...
                try {
                    ...
                    System.out.println("All deposits committed successfully.");
                    ...
                    System.out.println("Second and third deposits rolled back.");
                    System.out.println("Rolled back to Savepoint 1.");

                    con.commit();

                    System.out.println("First deposit committed successfully.");
                }
